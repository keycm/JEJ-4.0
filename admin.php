...
if(isset($_POST['save_lot'])){
    ...
    // Process the new pricing rules into the overview
    ...
    // Prepend pricing context to overview so buyers see the terms
    ...
    // These are the dynamically calculated prices from the JavaScript frontend
...
if($checkTable && $checkTable->num_rows > 0) {
    ...
    while($tx = $txQuery->fetch_assoc()){
        $color = ($tx['type'] == 'INCOME') ? '#43a047' : '#d84315';
    ...
    <div class="main-panel">
        ...
        <div class="top-header">
            <div class="header-title">
                ...
                <p><?= $view == 'dashboard' ? "Welcome back! Here's what's happening with your estate today." : "Configure land pricing, lot classification, and payment installments." ?></p>
            </div>
        ...
        <div class="content-area">
            ...
            <?php elseif($view == 'inventory'): ?>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="property_type" class="form-control" placeholder="e.g. Residential Lot" value="<?= $edit_mode ? $edit_data['property_type'] : 'Residential Lot' ?>" required>
                                </div>
                                <div class="input-group">
                            ...
                            <div class="form-grid-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="lot_class" id="lot_class" class="form-control" onchange="calcTotal()">
                                        ...
                                        <option value="Front Lot">Front Lot (+₱200/sqm Premium)</option>
                                    </select>
                                </div>
                                <div class="input-group">
                                    ...
                                    <select name="terms" id="terms" class="form-control" onchange="calcTotal()">
                                        ...
                                        <option value="4">4 Years Installment (+₱200/sqm Excess)</option>
                                        <option value="5">5 Years Installment (+₱400/sqm Excess)</option>
                                    </select>
                                </div>
                                ...
                                <div class="box-highlight">
                                    <div style="flex: 1;">
                                        <span style="display: block; font-size: 11px; font-weight: 700; color: #0369a1; text-transform: uppercase; letter-spacing: 0.5px;">Adjusted Price / SQM</span>
                ...
                <script>
                // Complex Pricing Algorithm Matching The Desired Image Layout
                function calcTotal(){
                    ...
                    let lotClass = document.getElementById('lot_class').value;
                    let terms = parseInt(document.getElementById('terms').value) || 0;
                    
                    let adjustedPriceSqm = basePrice;
                    
                    // 1. Classification Premium (+200/sqm for Front Lots)
                    if (lotClass === 'Front Lot') {
                        adjustedPriceSqm += 200; 
                    }
                    
                    // 2. Installment Premium Calculation (+200/sqm for every year EXCEEDING 3 years)
                    if (terms > 3) {
                        let excessYears = terms - 3; // e.g., 4 yrs = 1 excess, 5 yrs = 2 excess
                        adjustedPriceSqm += (excessYears * 200);
                    }
                    
                    let totalPrice = area * adjustedPriceSqm;
                    
                    // Update Hidden DB Inputs
                    ...
                    // 3. Dynamic Monthly Amortization UI Update
                ...
                // Initial setup
                document.addEventListener('DOMContentLoaded', function() {
                    calcTotal(); // Trigger calculation on load
